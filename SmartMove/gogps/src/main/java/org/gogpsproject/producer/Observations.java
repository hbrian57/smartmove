...
public class Observations implements Streamable {
	...
	public LinkedHashMap<String, ObservationSet> obsSetHM;
	...
	public HashMap<String, ObservationSet> getObsSetHM()
	{
		return obsSetHM;
	}

	public int getSizeSat()
	{
		return obsSetHM.size();
	}

	public ObservationSet getSatByIdx_HM(String idx) {
		return obsSetHM.get(idx);
	}
...
//	}
	...
	public void setGps(int i, ObservationSet os ){
		if(obsSetHM == null)
		{
			obsSetHM = new LinkedHashMap<String, ObservationSet>();
		}
		String key = "" + os.getSatType() + os.getSatID();
		obsSetHM.put(key, os);

		//TODO replace by a HashMap for easier access
