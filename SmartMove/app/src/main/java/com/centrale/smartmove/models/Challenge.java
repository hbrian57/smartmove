...
=======
>>>>>>> 343f33e (v1 de : Modifier updateProgression pour qu'un défi soit marqué comme terminé+ que ca fasse appel à la fonction qui choisi un nouveau défi+ notif (pusher dans la bonne branche))
